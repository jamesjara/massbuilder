...
class cuserlevels_delete extends cuserlevels {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate($this->james_url( "userlevelslist.php" )); // Prevent SQL injection, return to list
...
if ($userlevels_deleteTotalRecs <= 0) { // No record found, exit
	...
	$userlevels_delete->Page_Terminate($this->james_url( "userlevelslist.php" )); // Return to list
}
?>
<h4 id="ewPageCaption" class="page-header ewTitle ewTableTitle"> <?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $userlevels->TableCaption() ?></h4>
...
<?php } ?>
<br />
<table id="tbl_userlevelsdelete" class="ewTable ewTableSeparate table table-striped table-bordered ">
<?php echo $userlevels->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<th><span id="elh_userlevels_userlevelid" class="userlevels_userlevelid">
		<?php echo $userlevels->userlevelid->FldCaption() ?></span></th>
		<th><span id="elh_userlevels_userlevelname" class="userlevels_userlevelname">
		<?php echo $userlevels->userlevelname->FldCaption() ?></span></th>
	</tr>
	</thead>
	<tbody>
<?php
