	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["userlevelid"] <> "") {
				...
				$sReturnUrl = $this->james_url( "userlevelslist.php" ); // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = $this->james_url( "userlevelslist.php" ); // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = $this->james_url( "userlevelslist.php" ); // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
<h4 id="ewPageCaption" class="page-header ewTitle ewTableTitle"> <?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $userlevels->TableCaption() ?>&nbsp;&nbsp;</h4>
<a href="<?php echo $userlevels_view->ListUrl ?>" id="a_BackToList" class="ewLink label"><i class="icon-arrow-left icon-white"></i> <?php echo $Language->Phrase("BackToList") ?></a>
<?php //jamesjara
...
<a href="<?php echo $userlevels_view->AddUrl ?>" id="a_AddLink" class="ewLink ewGridLink btn btn-success"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>
<?php } ?>
<?php } ?>
<?php if ($Security->CanEdit()) { ?>
<?php if ($userlevels_view->EditUrl <> "") { ?>
<a href="<?php echo $userlevels_view->EditUrl ?>" id="a_EditLink" class="ewLink btn btn-primary"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>
<?php } ?>
<?php } ?>
<?php if ($Security->CanAdd()) { ?>
...
<a href="<?php echo $userlevels_view->DeleteUrl ?>" id="a_DeleteLink" class="ewLink  btn btn-danger"><?php echo $Language->Phrase("ViewPageDeleteLink") ?></a>
<?php } ?>
<?php } ?>
...
<table id="tbl_userlevelsview" class="ewTable ewTableSeparate table table-striped ">
<?php if ($userlevels->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid"<?php echo $userlevels->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_userlevels_userlevelid"><table class="ewTableHeaderBtn"><tr><td><b><?php echo $userlevels->userlevelid->FldCaption() ?></b></td></tr></table></span></td>
...
<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
	<tr id="r_userlevelname"<?php echo $userlevels->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_userlevels_userlevelname"><table class="ewTableHeaderBtn"><tr><td><b><?php echo $userlevels->userlevelname->FldCaption() ?></b></td></tr></table></span></td>
