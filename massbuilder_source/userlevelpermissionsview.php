	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["userlevelid"] <> "") {
				...
				$sReturnUrl = $this->james_url( "userlevelpermissionslist.php" ); // Return to list
			}
			if (@$_GET["_tablename"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = $this->james_url( "userlevelpermissionslist.php" ); // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = $this->james_url( "userlevelpermissionslist.php" ); // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
<h4 id="ewPageCaption" class="page-header ewTitle ewTableTitle"> <?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $userlevelpermissions->TableCaption() ?>&nbsp;&nbsp;</h4>
<a href="<?php echo $userlevelpermissions_view->ListUrl ?>" id="a_BackToList" class="ewLink label"><i class="icon-arrow-left icon-white"></i> <?php echo $Language->Phrase("BackToList") ?></a>
<?php //jamesjara
...
<a href="<?php echo $userlevelpermissions_view->AddUrl ?>" id="a_AddLink" class="ewLink ewGridLink btn btn-success"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>
<?php } ?>
<?php } ?>
<?php if ($Security->CanEdit()) { ?>
<?php if ($userlevelpermissions_view->EditUrl <> "") { ?>
<a href="<?php echo $userlevelpermissions_view->EditUrl ?>" id="a_EditLink" class="ewLink btn btn-primary"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>
<?php } ?>
<?php } ?>
<?php if ($Security->CanAdd()) { ?>
...
<a href="<?php echo $userlevelpermissions_view->DeleteUrl ?>" id="a_DeleteLink" class="ewLink  btn btn-danger"><?php echo $Language->Phrase("ViewPageDeleteLink") ?></a>
<?php } ?>
<?php } ?>
...
<table id="tbl_userlevelpermissionsview" class="ewTable ewTableSeparate table table-striped ">
<?php if ($userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid"<?php echo $userlevelpermissions->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_userlevelpermissions_userlevelid"><table class="ewTableHeaderBtn"><tr><td><b><?php echo $userlevelpermissions->userlevelid->FldCaption() ?></b></td></tr></table></span></td>
...
<?php if ($userlevelpermissions->_tablename->Visible) { // tablename ?>
	<tr id="r__tablename"<?php echo $userlevelpermissions->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_userlevelpermissions__tablename"><table class="ewTableHeaderBtn"><tr><td><b><?php echo $userlevelpermissions->_tablename->FldCaption() ?></b></td></tr></table></span></td>
...
<?php if ($userlevelpermissions->permission->Visible) { // permission ?>
	<tr id="r_permission"<?php echo $userlevelpermissions->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_userlevelpermissions_permission"><table class="ewTableHeaderBtn"><tr><td><b><?php echo $userlevelpermissions->permission->FldCaption() ?></b></td></tr></table></span></td>
