...
class cuserlevels extends cTable {
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return $this->james_url( "userlevelslist.php" );
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl($this->james_url("userlevelsview.php"), $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return $this->james_url("userlevelsadd.php");
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl($this->james_url("userlevelsedit.php"), $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl($this->james_url("userlevelsadd.php"), $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl($this->james_url("userlevelsdelete.php"), $this->UrlParm());
	}
