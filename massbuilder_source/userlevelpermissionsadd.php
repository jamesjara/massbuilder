...
<h4 id="ewPageCaption" class="page-header ewTitle ewTableTitle"> <?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $userlevelpermissions->TableCaption() ?></h4>
...
<table id="tbl_userlevelpermissionsadd" class="ewTable ewTableSeparate table table-striped ">
