...
$fb_group_entries_add = NULL; // Initialize page object first

class cfb_group_entries_add extends cfb_group_entries {
	...
	// Page object name
	var $PageObjName = 'fb_group_entries_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "fb_group_entriesview.php")
	...
	function LoadDefaultValues() {
		...
		$this->record_time->CurrentValue = NULL;
		$this->record_time->OldValue = $this->record_time->CurrentValue;
		...
		$this->md5->CurrentValue = NULL;
		$this->md5->OldValue = $this->md5->CurrentValue;
		...
		$this->properties->OldValue = $this->properties->CurrentValue;
		$this->message_tags->CurrentValue = NULL;
		$this->message_tags->OldValue = $this->message_tags->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// record_time
		$this->record_time->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->record_time->CurrentValue, 5), NULL, FALSE);
		...
		// md5
		$this->md5->SetDbValueDef($rsnew, $this->md5->CurrentValue, NULL, FALSE);
		...
		// properties
		$this->properties->SetDbValueDef($rsnew, $this->properties->CurrentValue, NULL, FALSE);

		// message_tags
		$this->message_tags->SetDbValueDef($rsnew, $this->message_tags->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($fb_group_entries_add)) $fb_group_entries_add = new cfb_group_entries_add();

// Page init
$fb_group_entries_add->Page_Init();

// Page main
$fb_group_entries_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var fb_group_entries_add = new ew_Page("fb_group_entries_add");
fb_group_entries_add.PageID = "add"; // Page ID
var EW_PAGE_ID = fb_group_entries_add.PageID; // For backward compatibility

// Form object
var ffb_group_entriesadd = new ew_Form("ffb_group_entriesadd");

// Validate form
ffb_group_entriesadd.Validate = function(fobj) {
...
ffb_group_entriesadd.Form_CustomValidate =  
...
ffb_group_entriesadd.ValidateRequired = true;
<?php } else { ?>
ffb_group_entriesadd.ValidateRequired = false; 
<?php } ?>
...
<h4 id="ewPageCaption" class="page-header ewTitle ewTableTitle"> <?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $fb_group_entries->TableCaption() ?></h4>
...
<?php $fb_group_entries_add->ShowPageHeader(); ?>
<?php
$fb_group_entries_add->ShowMessage();
?>
<form name="ffb_group_entriesadd" id="ffb_group_entriesadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<input type="hidden" name="t" value="fb_group_entries" />
<input type="hidden" name="a_add" id="a_add" value="A" />
<table id="tbl_fb_group_entriesadd" class="ewTable ewTableSeparate table table-striped ">
...
<script type="text/javascript">
ffb_group_entriesadd.Init();
</script>
<?php
$fb_group_entries_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$fb_group_entries_add->Page_Terminate();
?>
