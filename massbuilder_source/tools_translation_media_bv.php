...
$tools_translation_media_blobview = NULL; // Initialize page object first

class ctools_translation_media_blobview extends ctools_translation {
	...
	// Page object name
	var $PageObjName = 'tools_translation_media_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'tools_translation');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('tools_translation', 'x_media');
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (!EW_DEBUG_ENABLED && ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('media');
...
// Create page object
if (!isset($tools_translation_media_blobview)) $tools_translation_media_blobview = new ctools_translation_media_blobview();

// Page init
$tools_translation_media_blobview->Page_Init();

// Page main
$tools_translation_media_blobview->Page_Main();
?>
<?php
$tools_translation_media_blobview->Page_Terminate();
?>
