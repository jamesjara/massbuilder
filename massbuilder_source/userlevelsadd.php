...
<h4 id="ewPageCaption" class="page-header ewTitle ewTableTitle"> <?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $userlevels->TableCaption() ?></h4>
...
<table id="tbl_userlevelsadd" class="ewTable ewTableSeparate table table-striped ">
