...
class cuserlevelpermissions_edit extends cuserlevelpermissions {
	...
	function Page_Main() {
		...
		if ($this->userlevelid->CurrentValue == "")
			$this->Page_Terminate($this->james_url( "userlevelpermissionslist.php" )); // Invalid key, return to list
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate($this->james_url( "userlevelpermissionslist.php" )); // No matching record, return to list
				}
				break;
			Case "U": // Update
...
<h4 id="ewPageCaption" class="page-header ewTitle ewTableTitle"> <?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $userlevelpermissions->TableCaption() ?></h4>
<a href="<?php echo $userlevelpermissions->getReturnUrl() ?>" id="a_GoBack" class="ewLink label"><i class="icon-arrow-left icon-white"></i> <?php echo $Language->Phrase("GoBack") ?></a>
...
<table id="tbl_userlevelpermissionsedit" class="ewTable ewTableSeparate table table-striped ">
<?php if ($userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid"<?php echo $userlevelpermissions->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_userlevelpermissions_userlevelid">
		<b><?php echo $userlevelpermissions->userlevelid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></b>
		</span></td>
...
<?php if ($userlevelpermissions->_tablename->Visible) { // tablename ?>
	<tr id="r__tablename"<?php echo $userlevelpermissions->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_userlevelpermissions__tablename">
		<b><?php echo $userlevelpermissions->_tablename->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></b>
		</span></td>
...
<?php if ($userlevelpermissions->permission->Visible) { // permission ?>
	<tr id="r_permission"<?php echo $userlevelpermissions->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_userlevelpermissions_permission">
		<b><?php echo $userlevelpermissions->permission->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></b>
		</span></td>
