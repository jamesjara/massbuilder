...
define("EW_PROJECT_NAME", "massbuilder", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{3554BCCA-7E88-4E52-9661-DF55D75275C9}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'lgZ2icMdD0kh8hhk', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/massbuilder.css", TRUE); // Project stylesheet file name
...
// define("EW_CONN_DB", 'massbuilder', TRUE);
...
// Security
define("EW_ADMIN_USER_NAME", "ad", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "ad", TRUE); // Administrator password
...
define("EW_USER_NAME_FILTER", "(`user` = '%u')",  TRUE);
define("EW_USER_ID_FILTER", "(`idusers` = %u)",  TRUE);
define("EW_USER_EMAIL_FILTER", "(`email` = '%e')",  TRUE);
define("EW_USER_ACTIVATE_FILTER", "",  TRUE);
define("EW_USER_PROFILE_FIELD_NAME", "promo",  TRUE);
...
// File upload
// define("EW_UPLOAD_DEST_PATH", "uploas/", TRUE); // Upload destination path (relative to app root)

define("EW_UPLOAD_DEST_PATH", "uploads/".conf_domain.'/', TRUE); //jamesjara Upload destination path (relative to app root)
...
// Menu
define("EW_MENUBAR_CLASSNAME", "EW_MENUBAR_CLASSNAME", TRUE);
define("EW_MENUBAR_ITEM_CLASSNAME", "EW_MENUBAR_ITEM_CLASSNAME", TRUE);
define("EW_MENUBAR_ITEM_LABEL_CLASSNAME", "EW_MENUBAR_ITEM_LABEL_CLASSNAME", TRUE);
define("EW_MENU_CLASSNAME", "EW_MENU_CLASSNAME", TRUE);
define("EW_MENU_ITEM_CLASSNAME", "EW_MENU_ITEM_CLASSNAME", TRUE);
define("EW_MENU_ITEM_LABEL_CLASSNAME", "EW_MENU_ITEM_LABEL_CLASSNAME", TRUE);
?>
<?php
