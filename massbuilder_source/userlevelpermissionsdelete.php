...
class cuserlevelpermissions_delete extends cuserlevelpermissions {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate($this->james_url( "userlevelpermissionslist.php" )); // Prevent SQL injection, return to list
...
if ($userlevelpermissions_deleteTotalRecs <= 0) { // No record found, exit
	...
	$userlevelpermissions_delete->Page_Terminate($this->james_url( "userlevelpermissionslist.php" )); // Return to list
}
?>
<h4 id="ewPageCaption" class="page-header ewTitle ewTableTitle"> <?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $userlevelpermissions->TableCaption() ?></h4>
...
<?php } ?>
<br />
<table id="tbl_userlevelpermissionsdelete" class="ewTable ewTableSeparate table table-striped table-bordered ">
<?php echo $userlevelpermissions->TableCustomInnerHtml ?>
	...
	<tr class="ewTableHeader">
		...
		<?php echo $userlevelpermissions->userlevelid->FldCaption() ?></span></th>
		<th><span id="elh_userlevelpermissions__tablename" class="userlevelpermissions__tablename">
		<?php echo $userlevelpermissions->_tablename->FldCaption() ?></span></th>
		<th><span id="elh_userlevelpermissions_permission" class="userlevelpermissions_permission">
		<?php echo $userlevelpermissions->permission->FldCaption() ?></span></th>
	</tr>
	</thead>
	<tbody>
<?php
