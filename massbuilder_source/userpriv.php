...
<table id="tbl_userpriv" class="ewTable ewTableSeparate table table-striped table-bordered ">
	<thead>
	<tr class="ewTableHeader">
		<th><table class="ewTableHeaderBtn"><tr><td><?php echo $Language->Phrase("TableOrView") ?></td></tr></table></td>
		<th><table class="ewTableHeaderBtn"><tr><td><?php echo $Language->Phrase("PermissionAddCopy") ?><input type="checkbox" name="Add" id="Add" onclick="ew_SelectAll(this);"<?php echo $userpriv->Disabled ?> /></td></tr></table></th>
		<th><table class="ewTableHeaderBtn"><tr><td><?php echo $Language->Phrase("PermissionDelete") ?><input type="checkbox" name="Delete" id="Delete" onclick="ew_SelectAll(this);"<?php echo $userpriv->Disabled ?> /></td></tr></table></th>
		<th><table class="ewTableHeaderBtn"><tr><td><?php echo $Language->Phrase("PermissionEdit") ?><input type="checkbox" name="Edit" id="Edit" onclick="ew_SelectAll(this);"<?php echo $userpriv->Disabled ?> /></td></tr></table></th>
<?php if (defined("EW_USER_LEVEL_COMPAT")) { ?>
		<th><table class="ewTableHeaderBtn"><tr><td><?php echo $Language->Phrase("PermissionListSearchView") ?><input type="checkbox" name="List" id="List" onclick="ew_SelectAll(this);"<?php echo $userpriv->Disabled ?> /></td></tr></table></th>
<?php } else { ?>
		<th><table class="ewTableHeaderBtn"><tr><td><?php echo $Language->Phrase("PermissionList") ?><input type="checkbox" name="List" id="List" onclick="ew_SelectAll(this);"<?php echo $userpriv->Disabled ?> /></td></tr></table></th>
		<th><table class="ewTableHeaderBtn"><tr><td><?php echo $Language->Phrase("PermissionView") ?><input type="checkbox" name="View" id="View" onclick="ew_SelectAll(this);"<?php echo $userpriv->Disabled ?> /></td></tr></table></th>
		<th><table class="ewTableHeaderBtn"><tr><td><?php echo $Language->Phrase("PermissionSearch") ?><input type="checkbox" name="Search" id="Search" onclick="ew_SelectAll(this);"<?php echo $userpriv->Disabled ?> /></td></tr></table></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
