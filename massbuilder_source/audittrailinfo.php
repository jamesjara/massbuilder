...
class caudittrail extends cTable {
	...
	function __construct() {
		...
		// datetime
		$this->datetime = new cField('audittrail', 'audittrail', 'x_datetime', 'datetime', '`datetime`', 'DATE_FORMAT(`datetime`, \'%Y/%m/%d %H:%i:%s\')', 135, 5, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return $this->james_url( "audittraillist.php" );
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl($this->james_url("audittrailview.php"), $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return $this->james_url("audittrailadd.php");
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl($this->james_url("audittrailedit.php"), $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl($this->james_url("audittrailadd.php"), $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl($this->james_url("audittraildelete.php"), $this->UrlParm());
	}
